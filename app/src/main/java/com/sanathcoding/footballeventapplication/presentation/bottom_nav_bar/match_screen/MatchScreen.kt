...
import com.sanathcoding.footballeventapplication.presentation.bottom_nav_bar.match_screen.component.*

@Composable
fun MatchScreen(
    matchScreenViewModel: MatchScreenViewModel = hiltViewModel()
) {
    val state = matchScreenViewModel.state
